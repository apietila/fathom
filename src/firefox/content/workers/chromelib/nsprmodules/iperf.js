...
//		settings.mMode = TestMode.kTest_DualTest;
	...
	case ThreadMode.kMode_Listener:
	    return listener(); // wait incoming connections
	    break;
...
// Methods exposed to the worker global namespace
var iperfStart = iperf.start;
var iperfStop = iperf.stop;
util.registerAction('iperfStart'); // start client/server
util.registerAction('iperfStop');  // stop running server
