...
var ping = (function() { // using closure to hide the internal helpers
    ...
    var start = function(sid, dst, args) {
...
// Public methods in the global worker namespace
var pingStart = ping.start;
var pingStop = ping.stop;
util.registerAction('pingStart');
